                      ...
                      <?php 
                        ...
                        foreach($results as $index => $values) {
                          ...
                          <td>
                            ...
                            <a  onclick="return confirm('are you sure you want to delete this row ?')"  href="?page=categories&action=delete&category_id=<?php echo $values['id']; ?>"><span class="badge text-bg-danger">Delete</span></a>
                          </td>
                        </tr>
                        <?php }
                      ?>
